...
export const REQUIRED_SECRETS = [
  ...
  { name: 'AI1_BASE_URL',       from: '硅基流动控制台（https://cloud.siliconflow.cn）',
    hint: 'AI-1（Clean/Tag/JsonExtract）的 API base URL' },
  { name: 'AI1_API_KEY',        from: '硅基流动控制台',
    hint: 'AI-1 的 API key' },
  { name: 'AI1_MODEL',          from: '可选。推荐 Qwen/Qwen2.5-32B-Instruct',
    hint: 'AI-1 的模型 ID' },
  { name: 'AI2_BASE_URL',       from: '硅基流动控制台',
    hint: 'AI-2（Translate/CoverFigure）的 API base URL' },
  { name: 'AI2_API_KEY',        from: '硅基流动控制台',
    hint: 'AI-2 的 API key' },
  { name: 'AI2_MODEL',          from: '可选。推荐 Qwen/Qwen2.5-72B-Instruct',
    hint: 'AI-2 的模型 ID' },
] as const
