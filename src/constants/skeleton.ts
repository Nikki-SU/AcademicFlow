...
const VOCABULARY_CSV = `id,word,phonetic,meaning,example_en,example_zh,root,mastered,proficiency,error_count,last_study_time,seen_count
w1,perovskite,/pəˈrɒvskaɪt/,钙钛矿,"Perovskite solar cells have achieved remarkable efficiency improvements in recent years.","钙钛矿太阳能电池近年来在效率上取得了显著的提升。","perov- (钙钛矿结构) + -skite (矿)",0,0,0,0,0
w2,catalysis,/kəˈtælɪsɪs/,催化,"Heterogeneous catalysis plays a vital role in industrial chemical processes.","多相催化在工业化学过程中起着至关重要的作用。","cata- 向下 + lysis 溶解",0,0,0,0,0
w3,electrolyte,/ɪˈlektrəlaɪt/,电解质,"The electrolyte enables ion transport between the anode and cathode.","电解质使离子能够在阳极和阴极之间传输。","electro- 电 + lyte 溶解物",0,0,0,0,0
`

const SENTENCES_CSV = `id,en,zh,structure,mastered
s1,"The power conversion efficiency of perovskite solar cells has increased dramatically over the past decade.","钙钛矿太阳能电池的功率转换效率在过去十年中大幅提升。","subject:The power conversion efficiency|predicate:has increased|object:",0
`

const TRANSLATION_CSV = `id,source,reference,mastered
t1,"该研究揭示了钙钛矿材料中载流子输运的微观机制。","This study reveals the microscopic mechanism of carrier transport in perovskite materials.",0
`

const KEYWORD_GROUPS_CSV = `id,name,keywords,enabled
kg1,"钙钛矿太阳能电池","perovskite,solar cell,efficiency,stability",1
kg2,"CO2电催化还原","CO2 reduction,electrocatalysis,copper,faradaic efficiency",1
`

const LITERATURES_CSV = `id,doi,title,authors,year,journal,keywords,tier,has_graphical_abstract,added_at
1,10.1038/s41560-024-01432-1,钙钛矿太阳能电池综述,"Smith et al.",2024,Nature Energy,"solar,perovskite",2,1,1784195716
2,10.1021/jacs.3c04567,CO2 还原电催化剂设计,"Zhang et al.",2023,JACS,"catalysis,CO2",1,0,1784195716
`

const TEXTBOOKS_CSV = `id,title,authors,publisher,total_pages,volume_count,category,status,added_at
tb1,物理化学,"Atkins P., de Paula J.",Oxford University Press,1200,1,物理化学,completed,1784195716
tb2,材料科学基础,"Callister W.D.",Wiley,980,1,材料科学,completed,1784195716
`

const PROJECTS_CSV = `id,name,stage,description,created_at,updated_at
p1,钙钛矿太阳能电池效率研究,literature_review,"研究钙钛矿太阳能电池的效率提升机制",1784195716,1784195716
`
