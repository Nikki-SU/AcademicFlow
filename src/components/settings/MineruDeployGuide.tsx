    ...
    <div className="space-y-3">
      ...
      <ol className="text-xs text-slate-600 space-y-2.5 pl-4 list-decimal">
        <li>
          ...
          <p className="mt-1 text-[11px] text-slate-400">按页面指引安装，支持 Windows / macOS / Linux</p>
        </li>
        ...
        <li>
          ...
          <p className="mt-1 text-[11px] text-slate-400">启动后显示 <code className="px-1 py-0.5 bg-slate-100 rounded text-[10px]">Listening on http://localhost:8000/</code></p>
        </li>
      </ol>
      ...
      <div className="flex items-start gap-2 p-2.5 bg-green-50 border border-green-200 rounded-md">
        ...
        <div className="text-[11px] text-green-700">
          ...
          <code className="px-1.5 py-0.5 bg-white border border-green-200 rounded text-[10px]">http://localhost:8000</code>
      ...
      <div className="flex items-start gap-2 p-2.5 bg-blue-50 border border-blue-200 rounded-md">
        ...
        <div className="text-[11px] text-blue-700">
          ...
          <div className="mt-1">
            Windows 用户可以创建 <code className="px-1 py-0.5 bg-white border border-blue-200 rounded text-[10px]">start-proxy.bat</code> 文件：
            <pre className="mt-1 px-2 py-1 bg-white border border-blue-200 rounded text-[10px] font-mono whitespace-pre-wrap">
@echo off
