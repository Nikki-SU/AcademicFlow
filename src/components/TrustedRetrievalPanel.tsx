...
const DEMO_LITERATURE: LiteratureItem[] = [
  ...
  {
    id: 'lit-3',
    title: '示例论文：数据可视化最佳实践',
    authors: 'Author F, Author G, Author H',
    year: 2024,
    journal: 'Sample Journal',
  ...
  {
    id: 'lit-5',
    title: '示例论文：实验设计与可复现性',
    authors: 'Author K, Author L, Author M',
    year: 2024,
    journal: 'Sample Journal',
  ...
  {
    id: 'lit-6',
    title: '示例论文：开放科学与数据共享',
    authors: 'Author N, Author O',
    year: 2023,
    journal: 'Sample Journal',
  ...
  },
  {
    id: 'lit-7',
    title: '示例论文：同行评审流程解析',
    authors: 'Author P, Author Q, Author R',
    year: 2024,
    journal: 'Sample Journal',
...
const DEMO_BOOKS: BookItem[] = [
  {
    ...
    chapters: [
      { id: 'ch-1-1', bookId: 'book-1', title: '研究问题与选题', number: '第1章', pageRange: 'P1-P45' },
      { id: 'ch-1-2', bookId: 'book-1', title: '文献检索与综述', number: '第2章', pageRange: 'P46-P89' },
      { id: 'ch-1-3', bookId: 'book-1', title: '研究设计与方法', number: '第3章', pageRange: 'P90-P134' },
      { id: 'ch-1-4', bookId: 'book-1', title: '数据分析基础', number: '第4章', pageRange: 'P135-P198' },
      { id: 'ch-1-5', bookId: 'book-1', title: '学术写作规范', number: '第5章', pageRange: 'P199-P256' },
      { id: 'ch-1-6', bookId: 'book-1', title: '引用与参考文献', number: '第6章', pageRange: 'P257-P312' },
    ],
  },
  {
    id: 'book-2',
    ...
    chapters: [
      { id: 'ch-2-1', bookId: 'book-2', title: '论文结构与逻辑', number: '第1章', pageRange: 'P1-P38' },
      { id: 'ch-2-2', bookId: 'book-2', title: '摘要与引言写作', number: '第2章', pageRange: 'P39-P98' },
      { id: 'ch-2-3', bookId: 'book-2', title: '结果与讨论呈现', number: '第3章', pageRange: 'P99-P168' },
      { id: 'ch-2-4', bookId: 'book-2', title: '图表设计原则', number: '第4章', pageRange: 'P169-P225' },
      { id: 'ch-2-5', bookId: 'book-2', title: '投稿与同行评审', number: '第5章', pageRange: 'P226-P278' },
      { id: 'ch-2-6', bookId: 'book-2', title: '回应审稿意见', number: '第6章', pageRange: 'P279-P320' },
    ],
  },
  {
    id: 'book-3',
    ...
    chapters: [
      { id: 'ch-3-1', bookId: 'book-3', title: '项目规划与目标', number: '第1章', pageRange: 'P1-P28' },
      { id: 'ch-3-2', bookId: 'book-3', title: '时间管理与进度', number: '第2章', pageRange: 'P29-P76' },
      { id: 'ch-3-3', bookId: 'book-3', title: '文献管理系统', number: '第3章', pageRange: 'P77-P124' },
      { id: 'ch-3-4', bookId: 'book-3', title: '团队协作与沟通', number: '第4章', pageRange: 'P125-P158' },
      { id: 'ch-3-5', bookId: 'book-3', title: '学术伦理规范', number: '第5章', pageRange: 'P159-P210' },
      { id: 'ch-3-6', bookId: 'book-3', title: '成果展示与传播', number: '第6章', pageRange: 'P211-P256' },
      { id: 'ch-3-7', bookId: 'book-3', title: '职业规划建议', number: '第7章', pageRange: 'P257-P302' },
      { id: 'ch-3-8', bookId: 'book-3', title: '常见问题解答', number: '第8章', pageRange: 'P303-P356' },
    ],
  },
  {
    id: 'book-4',
    ...
    year: 2021,
    publisher: 'Sample Publisher',
    isbn: '978-0-000-00000-4',
    chapters: [
      { id: 'ch-4-1', bookId: 'book-4', title: '学术英语特点', number: '第1章', pageRange: 'P1-P52' },
      { id: 'ch-4-2', bookId: 'book-4', title: '常用句式与表达', number: '第2章', pageRange: 'P53-P110' },
      { id: 'ch-4-3', bookId: 'book-4', title: '段落与篇章结构', number: '第3章', pageRange: 'P111-P178' },
      { id: 'ch-4-4', bookId: 'book-4', title: '语法与措辞优化', number: '第4章', pageRange: 'P179-P234' },
    ],
  },
]
